...
# Найти тройку подряд идущих элементов, которые выдают максимальную
...
# не поняла как зациклить множество чтоб перебиралось, 
# хотела сразу сдвинуть на 2 создав второе множество, 
# но и тут неувязочка)) исправимся!
...
name = 'Alex'
age = 12
text = 'Меня зовут %s и мне %d лет' % (name, age) #s=str d=dijit
print(text)
...
pi = 3.1415
print(f'Число Пи с точностью два знака: {pi:.2f}') # вывести пи с 2мя знаками после запятой, f- float
# Число Пи с точностью два знака: 3.14

data = [3254, 4364314532, 43465474, 2342, 462256, 1747]
for item in data:
    print(f'{item:>10}') # число выравнивается по правому краю с отступом в 10 символов
